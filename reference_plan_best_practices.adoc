...
Para saber mais sobre como configurar um Open vSwitch em um host hipervisor, consulte o link:https://www.netapp.com/media/13134-tr4613.pdf["ONTAP Select na arquitetura de produtos KVM e melhores práticas"^] relatório técnico.
