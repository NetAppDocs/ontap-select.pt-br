...
. Selecione *Configurações e AutoSupport*, depois selecione image:icon_pencil.gif["Editar"].
. Forneça os dados de configuração adequados ao seu ambiente e selecione *Modificar*.
+
...
. Inicie sessão na interface de utilizador da Web do utilitário de implementação utilizando a conta de administrador.
. Selecione a guia *Administration* na parte superior da página.
. Selecione *Eventos & Empregos* e, em seguida, selecione *Eventos*.
. Opcionalmente, selecione *Filtrar* e crie um filtro para limitar as mensagens de evento exibidas.
...
. Inicie sessão na interface de utilizador da Web do utilitário de implementação utilizando a conta de administrador.
. Selecione a guia *Administration* na parte superior da página.
. Selecione *Configurações e AutoSupport* e, em seguida, selecione image:icon_kebab.gif["Opções"].
...
. Opcionalmente, selecione o pacote correto em *AutoSupport History* e, em seguida, selecione o ícone de download para salvar o arquivo AutoSupport em sua estação de trabalho local.
