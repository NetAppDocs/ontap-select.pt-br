...
---
= Requisitos de storage externo do VMware ESXi para ONTAP Select
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Analise a documentação da VMware e siga as melhores práticas aplicáveis identificadas para hosts ESXi. Além disso:
...
* Verifique se todos os arrays de armazenamento externo genéricos utilizam os recursos de redundância e HA disponíveis, sempre que possível
