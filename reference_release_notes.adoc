...
Você pode acessar o link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3351669["Notas de versão do ONTAP Select 9.17.1"^] para ver os detalhes sobre a versão atual.
