...
Você pode acessar o link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3378465["Notas de versão do ONTAP Select 9.19.1"^] para visualizar os detalhes sobre a versão atual.
