...
Pode aceder ao https://library.netapp.com/ecm/ecm_download_file/ECMLP3318065["Notas de versão do ONTAP Select 9.15.1"^] para visualizar os detalhes sobre a versão atual.
