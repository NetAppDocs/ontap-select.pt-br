...
Pode aceder ao link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3332465["Notas de versão do ONTAP Select 9.16.1"^] para visualizar os detalhes sobre a versão atual.
