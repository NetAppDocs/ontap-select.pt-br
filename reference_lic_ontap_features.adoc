...
+
O ONTAP Select é compatível com o SVM DR como origem e destino, no máximo 16 relacionamentos. A compatibilidade com SVM DR está limitada ao uso da versão de origem do ONTAP nas versões mais de 2. Por exemplo, a fonte ONTAP Select 9.12.1 pode se conetar ao ONTAP de destino versões 9.12.1, 9.13.1 ou 9.14.1.
...
* link:https://mysupport.netapp.com/site/systems/master-license-keys["Saiba mais sobre NetApp ONTAP Master License Keys"^]
