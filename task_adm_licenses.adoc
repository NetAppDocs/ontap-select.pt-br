...
. Opcionalmente, selecione *Filtrar* para limitar as licenças exibidas.
...
Para obter mais informações sobre ONTAP Select e renovação de licença, consulte a seção Licenças, instalação, atualizações e reversões no link:reference_faq.html#licenses-installation-upgrades-and-reverts["FAQ"].
