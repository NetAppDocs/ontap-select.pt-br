...
NOTE: Para saber mais sobre como configurar um vSwitch em um host hipervisor e o recurso de interface de alta velocidade, consulte a seção link:concept_nw_concepts_chars.html["Rede de mergulho profundo"].
...
Consulte a link:concept_nw_concepts_chars.html["Rede de mergulho profundo"] seção para obter mais informações sobre implantações com duas NICs.
...
Consulte a link:concept_nw_concepts_chars.html["Rede de mergulho profundo"] seção para obter mais informações sobre implantações com quatro NICs.
