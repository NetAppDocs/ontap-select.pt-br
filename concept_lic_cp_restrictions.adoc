...
Todos os nós com uma licença de Capacity Pool em um cluster ONTAP Select devem usar a mesma instância do License Manager. Como existe uma instância do License Manager em cada instância do Deploy, essa restrição é uma reafirmação do requisito existente de que a mesma instância do Deploy deve gerenciar todos os nós em um cluster.
