...
summary: Você pode usar o script a seguir para adicionar uma licença para um nó ONTAP Select. 
---
= Script para adicionar uma licença de nó
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Você pode usar o script a seguir para adicionar uma licença para um nó ONTAP Select.
