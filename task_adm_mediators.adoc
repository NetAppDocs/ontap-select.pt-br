...
. Selecione a aba *Administração* na parte superior da página, depois selecione *Mediadores*.
. Opcionalmente, selecione *Filtrar* para personalizar sua visualização dos clusters de dois nós monitorados pelo serviço de mediação.
