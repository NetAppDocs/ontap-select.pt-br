...
image:ST_20.jpg["Particionamento de disco RDD para clusters de múltiplos nós (pares de HA)"]
...
----
image:ST_21.jpg["Correspondência de um disco ONTAP Select ao disco ESXi correspondente"]
