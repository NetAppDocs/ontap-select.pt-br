...
.Passos
. Na página principal, role até o final e selecione *Cluster*.
. Selecione *GET /clusters/{cluster_id}* para exibir os detalhes da chamada da API usada para retornar informações sobre um cluster ONTAP Select.
