...
As licenças padrão, premium e premium XL oferecem suporte a uma ampla variedade de hardware e software. Para informações atualizadas sobre as versões de hardware e software, consulte a link:https://mysupport.netapp.com/matrix/["Ferramenta de Matriz de interoperabilidade"^].
...
====
.O que vem a seguir?
link:concept_lic_workflow.html["Saiba mais sobre como adquirir uma licença ONTAP Select"]
