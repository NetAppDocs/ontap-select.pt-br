...
.3+| Unidades de estado sólido (SSDs) em um ... | Configuração RAID de hardware | Não | Sim | Sim 
...
2+| Família CPU  a| 
Intel Xeon E5-26xx v3 (Haswell) ou posterior

AMD EPYC Embedded 9004 ou posterior e 8004
 a| 
Intel Xeon E5-26xx v3 (Haswell) ou posterior
...
====
.O que vem a seguir?
Saiba mais sobrelink:concept_lic_workflow.html["compra de uma licença ONTAP Select"]
