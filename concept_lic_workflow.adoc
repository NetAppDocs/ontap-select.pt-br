...
Site de licenciamento:: Você obtém uma licença de Capacity Tier e uma licença de Capacity Pool em sites diferentes.
...
.O que vem a seguir?
Saiba mais sobre as considerações para dimensionar uma licença do ONTAP Select:

* link:sizing-capacity-tier-license.html["Licença Capacity Tiers"]
* link:sizing-capacity-pool-license.html["Licença de Capacity Pools"]


.Informações relacionadas
link:task_adm_licenses.html["Saiba mais sobre como gerenciar licenças do ONTAP Select"]
