...
--
Suporte ao hipervisor KVM atualizado:: A partir do ONTAP Select 9.17.1, o hipervisor KVM é suportado no Red Hat Enterprise Linux (RHEL) 10.0 e 9.6 e no Rocky Linux 10.0 e 9.6.
+
--
[NOTE]
====
