...
--
Suporte ao hipervisor KVM atualizado:: A partir do ONTAP Select 9.17.1, o hipervisor KVM é suportado no Red Hat Enterprise Linux (RHEL) 10.1, 10.0, 9.7 e 9.6 e no Rocky Linux 10.1, 10.0, 9.7 e 9.6.
+
--
[NOTE]
====
Existem limitações no fluxo de trabalho RAID por software para hipervisores KVM em hosts RHEL 10.1 e 10.0 e Rocky Linux 10.1 e 10.0. Para mais informações, consulte os seguintes artigos da Knowledge Base:
