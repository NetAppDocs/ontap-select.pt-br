...
--
Suporte para SnapMirror cloud:: A partir do ONTAP Select 9.17.1, SnapMirror cloud é compatível com o ONTAP Select. SnapMirror cloud não possui licença por padrão para o ONTAP Select. Ao implantar um cluster ONTAP Select 9.17.1 ou atualizar um cluster ONTAP Select existente para a versão 9.17.1, você precisa solicitar uma licença SnapMirror cloud. Para obter mais informações, consulte link:reference_lic_ontap_features.html#other-ontap-features["Recursos do ONTAP licenciados separadamente"].
