...
`-username _username_`
 a| 
O nome de usuário que tem acesso a este host. Isso é necessário apenas se o host não for gerenciado por um servidor de gerenciamento (ou seja, um host ESXi gerenciado por um vCenter).
