...
summary: Você pode usar o script a seguir para redimensionar os nós em um cluster do ONTAP Select. 
---
= Script para redimensionar nós de cluster do ONTAP Select
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Você pode usar o script a seguir para redimensionar os nós em um cluster do ONTAP Select.
