...
Você pode atualizar o ONTAP Select Deploy 9.17.1 do ONTAP Select Deploy 9.16.1 ou 9.15.1.  Para atualizar do ONTAP Select Deploy 9.14.1 ou anterior, revise as notas de versão da sua versão do ONTAP Select .
